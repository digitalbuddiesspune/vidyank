...
import { progressData } from '../../data/studentData';

/**
 * Progress Page
 * Analytics UI with charts, subject performance, weak topics
 */
function Progress() {
  const [progress] = useState(progressData);

  // Placeholder chart data (in real app, would use a charting library)
  const chartData = progress.monthlyTrend;

  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Progress Analytics</h1>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Monthly Performance Trend</h2>
